...
class PoDetailScreen extends StatefulWidget {
  ...
  const PoDetailScreen({super.key, required this.poId, required this.poTitle, required this.statusFilter});
...
class _PoDetailScreenState extends State<PoDetailScreen> {
  ...
  Future<void> _deleteSubmission(BuildContext context, dynamic submissionId) async {
