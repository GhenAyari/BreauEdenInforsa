            ...
            child: Padding(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    const Text("BUREAU", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: AppColors.primary)),
                    const SizedBox(height: 6),
                    const Text("Sistem Informasi Himpunan"),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _isLoading ? const CircularProgressIndicator(color: Colors.white) : const Text("Masuk", style: TextStyle(fontSize: 16, color: Colors.white)),
                      ),
                    ),
                  ],
                ),
